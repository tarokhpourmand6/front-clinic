// src/components/appointments/LaserTable.jsx
import { useState } from "react";
import DatePicker from "../../components/DatePicker/DatePicker";
import { toPersianNumber, convertToObj } from "../../utils/number";
import { Plus } from "lucide-react";

export default function LaserTable({
  data,
  onDateChange,
  onTimeChange,
  onStatusChange,
  onPriceChange,
  onDelete,
  onOpenLaser,             // (appointmentId, currentPrice?)
  paymentMethods,          // فعلاً استفاده نمی‌شود
  onOpenPaymentModal,      // (appointmentId, paymentDetails, price)
  onPatientClick,          // NEW: کلیک روی نام بیمار (patientObj)
}) {
            ...
            <tr key={a._id} className="even:bg-gray-50 text-[12px]">
              ...
              <td className="border px-2 py-1">
                <input
                  ...
                  inputMode="numeric"
                />
                {Array.isArray(a?.laserAreas) && a.laserAreas.length > 0 && (
